...
namespace IDPSDashboard.Model
{
	public class eventsdetection
	{
        ...
        public eventsdetection(int EventsDetectionId, int IdsId, DateTime DateTime, int EventStatus, int EventsAlarmId, int IDPSEventId)
		{
		...
		{
            get { return _IDPSEventId; }
            set { _IDPSEventId = value; }
		}
